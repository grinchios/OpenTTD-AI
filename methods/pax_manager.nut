class BusManager extends Manager
{
	towns_used = null;
	pathfinder = null;
	DEBUG = true;
...
function BusManager::CleanUp(tile_1, tile_2, progress)
{
...
function BusManager::CreateNewRoute()
{
...
function BusManager::SelectBestEngine(cargo, distance, maximum_cost=INFINITY)
{
...
function BusManager::BuildAllAngles(tile, station_type=AIStation.STATION_NEW)
{
...
function BusManager::FindSuitableLocation(cargo, center_tile=0, max_distance=INFINITY)
{
...
function BusManager::BuildNewVehicle(engine, tile_1, tile_2, cargo, depot)
{
